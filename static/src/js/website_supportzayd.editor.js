odoo.define('website_supportzayd.new_help_page', function (require) {
'use strict';
    ...
    WebsiteNewMenu.include({
        ...
        new_help_page: function() {
             ...
             rpc.query({
			    model: 'website.supportzayd.help.groups',
				method: 'name_search',
				args: [],
...
odoo.define('website_supportzayd.new_help_group', function (require) {
'use strict';
