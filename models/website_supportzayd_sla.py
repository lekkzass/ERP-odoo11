...
class WebsiteSupportSLARule(models.Model):
    ...
    countdown_condition = fields.Selection([('business_only','Business Only'), ('24_hour','24 Hours')], default="24_hour", required="True", help="During what time do we start counting down the SLA timer", ondelete='set default')
...
class WebsiteSupportSLARuleCondition(models.Model):
    ...
    type = fields.Selection([('category','Category'), ('subcategory','Sub Category'), ('priority','Priority')], string="Type", required="True", ondelete='set default')
...
class WebsiteSupportSLAResponse(models.Model):
    ...
    countdown_condition = fields.Selection([('business_only','Business Only'), ('24_hour','24 Hours')], default="24_hour", required="True", ondelete='set default')
...
class WebsiteSupportSLAAlert(models.Model):
    ...
    type = fields.Selection([('email','Email')], default="email", string="Type", ondelete='set default')